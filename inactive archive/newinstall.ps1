...
# Check if any of the variables are 'unknown' and fail the script if so
if ($service -eq 'unknown' -or $speciality -eq 'unknown' -or $locale -eq 'unknown' -or $type -eq 'unknown' -or $pd -eq 'unknown' -or $environment -eq 'unknown' -or $domain -eq 'unknown' -or $az -eq 'unknown' -or $hostgroup -contains 'unknown' -or $proxystr -eq 'unknown' -or $serverfunction -eq 'unknown') {
