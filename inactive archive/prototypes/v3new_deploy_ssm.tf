locals {
  cost_centre_allowed_valuesxxx = jsondecode(file("../configuration_files/costcentre.json"))
  product_allowed_valuesxxx     = jsondecode(file("../configuration_files/product.json"))
}


resource "aws_ssm_document" "New_Dynatrace_Deployment_v3_nhtest" {
  name          = "New_Dynatrace_Deploymentv3nhtest"
  document_type = "Automation"
  content       = <<DOC
{
  "description": "Installs the Dynatrace Agent v3 nhtest",
  "schemaVersion": "0.3",
  "parameters": {
    "PSInstallScript": {
    ...
    "costcentre": {
      ...
      "type": "String",
      "default": "not-set",
      "allowedValues": ${jsonencode(local.cost_centre_allowed_valuesxxx)}
    },
    "product": {
      "description": "CProduct to apply to instances",
      "type": "String",
      "default": "not-set",
      "allowedValues": ${jsonencode(local.product_allowed_valuesxxx)}
    }
  },
  "mainSteps": [
    {
    ...
    },
    {
      ...
      "inputs": {
        ...
        "Script": "def exit_handler(events, context):\n    return {'message': 'Instance not running. Skipping.'}"
      }
    },
    {
      "name": "download_files",
    ...
    },
    {
      ...
      "nextStep": "install_and_configure_dynatrace"
    },
    {
